...
class ListasFormulariosRutas {
        ...
        config(): void {
                ...
                this.router.put('/api/list/Departamento/:idPais',ObtListarFormulariosControlador.GetListDepartamento);
                this.router.put('/api/list/Ciudad/:idDepartamento',ObtListarFormulariosControlador.GitListCiudad);
